...
parent.querySelector('#articleCardCaption').style.display = "block";
    ...
    if (myArticle.contact_two && myArticle.contact_two.length > 4) {
        parent.querySelector('#articleContact').innerText += myArticle.contact_two;
    }
